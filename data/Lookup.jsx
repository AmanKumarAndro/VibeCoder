...
export default {
  ...
  SIGNIN_HEADING: 'Continue With VibeCoder',
  SIGNIN_SUBHEADING: 'To use VibeCoder you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using VibeCoder, you agree to the collection of usage data for analytics.',
